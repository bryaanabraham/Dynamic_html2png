...
def html_to_image(html_file):
    try:
        ...
        driver.get("file:///D:/Mahindra%20AI/Projects/Birthday%20Card/Frame1/Frame1.html")

        time.sleep(2)  # Wait for page elements to load properly

        # Capture full-page screenshot
        screenshot_path = "send.png"
        ...
        cropped_img = img.crop((343, 0,951,874))
